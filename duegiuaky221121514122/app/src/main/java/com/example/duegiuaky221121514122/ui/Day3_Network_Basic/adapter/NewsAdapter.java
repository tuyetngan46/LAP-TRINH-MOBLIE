package com.example.duegiuaky221121514122.ui.Day3_Network_Basic.adapter;
...
public class NewsAdapter extends RecyclerView.Adapter{
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType){
        View itemView = activity.getLayoutInflater().inflate(R.layout.fragment_day3_item_news,parent,false);
