package com.example.duegiuaky221121514122.ui.Day3_Network_RecyclerView.adapter;
...
import com.example.duegiuaky221121514122.ui.Day3_Network_RecyclerView.model.Item; // Import đã sửa
...
public class NewsAdapter extends RecyclerView.Adapter {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = activity.getLayoutInflater().inflate(R.layout.fragment_day3_rc_item_news, parent, false);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        if (model.getImage() != null && !model.getImage().isEmpty()) {
            ...
            hd.ivCover.setImageResource(R.drawable.anhbasic);
        }
    }
